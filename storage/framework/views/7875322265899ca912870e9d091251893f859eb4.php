        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu <?php echo e(in_array(Route::currentRouteName(), ['exams.index', 'exams.edit', 'grades.index', 'grades.edit', 'marks.index', 'marks.manage', 'marks.bulk', 'marks.tabulation', 'marks.show', 'marks.batch_fix',]) ? 'nav-item-expanded nav-item-open' : ''); ?> ">
                    <a href="#" class="nav-link"><i class="icon-books"></i> <span> Test</span></a>
                        ...
                        <?php if(Qs::userIsTeamSA()): ?>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('exams.index')); ?>"
                                   class="nav-link <?php echo e((Route::is('exams.index')) ? 'active' : ''); ?>">Test List</a>
                            </li>

                            <li class="nav-item">
                                <a href="<?php echo e(route('examsresult.index')); ?>"
                                   class="nav-link <?php echo e((Route::is('examsresult.index')) ? 'active' : ''); ?>">Test Result</a>
                            </li>
                ...
                <li class="nav-item">
                    <a href="/chatify" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['chatify']) ? 'active' : ''); ?>"><i class="icon-bubble"></i> <span>Chatify</span></a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\fyp\resources\views/partials/menu.blade.php ENDPATH**/ ?>