                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-md-3">
                            ...
                            <select required data-placeholder="Select State First" class="select-search form-control" name="" id="">
                                <option value=""></option>
                            </select>
                        </div> -->
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fyp\resources\views/pages/support_team/students/add.blade.php ENDPATH**/ ?>